...
public class TelaGatoCadastro extends JFrame {
	...
	public TelaGatoCadastro(GatoRepositorio gatoRepo) {
		...
		JLabel lblTitulo = new JLabel("Cadastro de Gato");
		...
		btnCadastrar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				gatoRepo.cadastrar(gato);
				JOptionPane.showMessageDialog(btnCadastrar, "Gato cadastrado com sucesso!");
				dispose();
			}
		});
		btnCadastrar.setBounds(10, 143, 100, 23);
